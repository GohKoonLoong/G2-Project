...
public class ClassDTest {
	...
	public void FIMS_34() throws InterruptedException{
	     ...
	     //*[@id="dt_listing_length"]/label/span/span[2]/span/span[2]
	      ...
	      // userPreference.click();
	       ...
	       String expectedUserPreferenceText = "125580 records";  // Replace with the expected text or attribute
	...
	driver.findElement(By.xpath("//*[@id=\\\"list_menu_id_1044\"]")).click();
    Thread.sleep(1000);

    // Click List of Cheque Release
    driver.findElement(By.xpath("//*[@id=\\\"list_menu_id_1590\\")).click();
    Thread.sleep(1000);

    // Click on "Search" field in Cheque Release Page and enter Debtor ID "D46257"
   // driver.findElement(By.xpath("//*[@id=\"List_of_Cheque_Release_wf_filter\"]/label/input")).sendKeys("D46257");
   // Thread.sleep(2000);
    
    // Click the dropDown button on the “Display” field and select "10”
    driver.findElement(By.xpath("/html/body/div[4]/form/div/div[1]/div[2]/div[1]/label/span/span[2]/span/span[1]")).click();
    driver.findElement(By.xpath("/html/body/span/span/span[2]/ul/li[4]")).click();
    //driver.findElement(By.xpath("//*[@id=\"List_of_Cheque_Release_wf_length\"]/label/span/span[2]/span/span[2]")).click();
    Thread.sleep(1000);
    
    //Verify if the expected data is shown in the search result information
    WebElement dataShow = driver.findElement(By.xpath("/html/body/div[4]/form/div/div[1]/div[2]/div[5]"));
    String actualText = dataShow.getText();
    String expectedText = "125,580 records";
    
    //Assertion if data is not found
    Assert.assertEquals("Search data is not shown", expectedText, actualText);
    System.out.println("Search data does not exist in table");
